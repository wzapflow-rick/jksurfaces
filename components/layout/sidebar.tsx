...
import { LayoutDashboard, Package, Users, Crosshair, Settings, Radar, ScanSearch, Target, Store, Import } from "lucide-react"
...
const NAV = [
  ...
  { href: "/importar", label: "Importar anúncio", icon: Import },
