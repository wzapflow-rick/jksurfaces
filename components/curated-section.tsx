...
export function CuratedSection() {
  return (
    <section id="curadoria" className="bg-surface px-5 py-24 md:px-10 md:py-36" aria-labelledby="curadoria-title">
      <div className="mx-auto grid max-w-7xl items-center gap-12 md:grid-cols-2 md:gap-16">
        ...
        <div id="sobre" className="md:order-1">
          ...
          <h2 id="curadoria-title" className="display text-5xl leading-[.95] text-paper md:text-7xl">Curadoria<br />que inspira.</h2>
          <p className="mt-8 max-w-md text-sm leading-7 text-paper/60 md:text-base">
            Selecionamos marcas e peças que traduzem tendências, inovação e atemporalidade. Cada escolha nasce de um olhar atento ao que dura e ao que faz sentido no cotidiano.
          </p>
          <a href="#inspiracao" className="mt-9 inline-flex items-center gap-3 border-b border-champagne pb-2 text-[10px] uppercase tracking-[.24em] text-champagne transition-colors hover:text-paper">
            Conheça a curadoria <span aria-hidden="true">→</span>
          </a>
        </div>
      </div>
    </section>
